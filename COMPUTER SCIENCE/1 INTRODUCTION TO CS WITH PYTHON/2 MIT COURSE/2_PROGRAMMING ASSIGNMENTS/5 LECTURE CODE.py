...
###########
# this way we just overshoot our epsilon, that is to say the guess**2 will never be in the range of the epsilon
...
##########
# this code is the fixation of the previous one (and guess**2 <= x: in line 94)
# Add an extra stopping condition 
# and check for why the loop terminated (to make loop work make the epsilon 0.00001)
# x = 54321
# epsilon = 0.01
# num_guesses = 0
# guess = 0.0
...
# BIG IDEA It’s possible to overshoot the epsilon, so you need another end condition. changing the epsilon to greater vs smaller is always accuracy vs speed
...
print(f'count is {count-1} where {x-n} != {n*(count-1)}')
