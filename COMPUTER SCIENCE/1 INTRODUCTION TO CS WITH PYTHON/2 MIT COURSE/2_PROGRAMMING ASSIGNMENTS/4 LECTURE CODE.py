...
for i in range(5,6):
    if i%2 == 0:
        ...
        even = True
if not even:
    print(f'There are no even numbers in the range')
print(evensum)
...
if secret in range(1,10):
    ...
    print('The secret number is not in a range')
...
print(f'The are {len(common)} common characters in 2 strings')
####################################################
##################### END AT HOME ######################
######################################################
